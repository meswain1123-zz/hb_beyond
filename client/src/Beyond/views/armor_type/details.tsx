...
class ArmorTypeDetails extends Component<Props, State> {
          ...
          <Grid container spacing={1} direction="column">
            <Grid item>
              ...
              <Tooltip title={`Delete ${this.state.obj.name}`}>
                <Fab size="small" color="primary" style={{marginLeft: "8px"}}
                  onClick={ () => {
                    this.api.deleteObject("armor_type", this.state.obj).then((res: any) => {
            ...
            <Grid item>
              ...
              <Tooltip title={`Edit ${this.state.obj.name}`}>
                <Fab size="small" color="primary" style={{marginLeft: "8px"}}
                  onClick={ () => {
                    this.setState({ redirectTo:`/beyond/armor_type/edit/${this.state.obj._id}` });
                  }}>
                  <Edit/>
                </Fab>
              </Tooltip> 
...
export default connector(ArmorTypeDetails);
