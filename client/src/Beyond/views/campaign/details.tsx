...
const mapDispatch = {
  ...
  // addCampaign: (obj: Campaign) => ({ type: 'ADD', dataType: 'campaigns', payload: obj })
}
          ...
          <Grid container spacing={1} direction="column">
                  ...
                  onClick={ () => {
                    this.api.deleteObject(this.state.obj).then((res: any) => {
                      if (this.props.objects) { 
                        this.props.setCampaigns(this.props.objects.filter(o => o._id !== this.state.obj._id));
                        this.setState({ redirectTo:`/beyond/campaign` });
                      }
                    });
                  }}>
            ...
            <Grid item>
              ...
              <Tooltip title={`Edit ${this.state.obj.name}`}>
                <Fab size="small" color="primary" style={{marginLeft: "8px"}}
                  onClick={ () => {
                    this.setState({ redirectTo:`/beyond/campaign/edit/${this.state.obj._id}` });
                  }}>
                  <Edit/>
                </Fab>
              </Tooltip> 
