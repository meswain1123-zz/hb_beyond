...
const mapState = (state: RootState) => ({
  // objects: state.app.magic_item_keywords,
...
const mapDispatch = {
  ...
  // addMagicItemKeyword: (obj: MagicItemKeyword) => ({ type: 'ADD', dataType: 'magic_item_keywords', payload: obj })
}
          ...
          <Grid container spacing={1} direction="column">
            ...
            <Grid item>
              ...
              <Tooltip title={`Edit ${this.state.obj.name}`}>
                <Fab size="small" color="primary" style={{marginLeft: "8px"}}
                  onClick={ () => {
                    this.setState({ redirectTo:`/beyond/magic_item_keyword/edit/${this.state.obj._id}` });
                  }}>
                  <Edit/>
                </Fab>
              </Tooltip> 
