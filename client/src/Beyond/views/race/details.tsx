...
class RaceDetails extends Component<Props, State> {
          ...
          <Grid container spacing={1} direction="column">
            <Grid item>
              ...
              <Tooltip title={`Delete ${this.state.obj.name}`}>
                <Fab size="small" color="primary" style={{marginLeft: "8px"}}
                  onClick={ () => {
                    this.api.deleteObject("race", this.state.obj).then((res: any) => {
                      this.setState({ redirectTo:`/beyond/race` });
                    });
                  }}>
                  <DeleteForever/>
            ...
            <Grid item>
              ...
              <Tooltip title={`Edit ${this.state.obj.name}`}>
                <Fab size="small" color="primary" style={{marginLeft: "8px"}}
                  onClick={ () => {
                    this.setState({ redirectTo:`/beyond/race/edit/${this.state.obj._id}` });
                  }}>
                  <Edit/>
                </Fab>
              </Tooltip> 
...
export default connector(RaceDetails);
