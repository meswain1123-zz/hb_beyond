...
const mapDispatch = {
  ...
  // addCondition: (obj: Condition) => ({ type: 'ADD', dataType: 'conditions', payload: obj })
}
          ...
          <Grid container spacing={1} direction="column">
                  ...
                  onClick={ () => {
                    this.api.deleteObject(this.state.obj).then((res: any) => {
                      if (this.props.objects) {
                        // this.props.setConditions(this.props.objects.filter(o => o._id !== this.state.obj._id));
                        this.setState({ redirectTo:`/beyond/condition` });
                      }
                    });
                  }}>
            ...
            <Grid item>
              ...
              <Tooltip title={`Edit ${this.state.obj.name}`}>
                <Fab size="small" color="primary" style={{marginLeft: "8px"}}
                  onClick={ () => {
                    this.setState({ redirectTo:`/beyond/condition/edit/${this.state.obj._id}` });
                  }}>
                  <Edit/>
                </Fab>
              </Tooltip> 
