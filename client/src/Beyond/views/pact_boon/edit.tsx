...
class PactBoonEdit extends Component<Props, State> {
  ...
  // Loads the editing Pact Boon into state
  load_object(id: string) {
    const objectFinder = this.state.pact_boons ? this.state.pact_boons.filter(o => o._id === id) : [];
          ...
          <Grid container spacing={1} direction="column">
            ...
            <Grid item>
              <span className={"MuiTypography-root MuiListItemText-primary header"}>
                { this.state.obj._id === "" ? "Create Pact Boon" : `Edit ${this.state.obj.name}` }
              </span>
            </Grid>
            <Grid item 
              style={{ 
            ...
            <Grid item>
              ...
              { (this.state.obj.name === "" || !this.state.child_names_valid) && 
                <span style={{ color: "red", marginLeft: "4px" }}>
                  The Pact Boon, all Feature Bases, Features, Feature Choices, and Options must have names.
                </span>
              }
            </Grid>
          </Grid>
...
export default connector(PactBoonEdit);
