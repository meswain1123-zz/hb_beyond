...
const mapState = (state: RootState) => ({
  // objects: state.app.weapon_keywords,
...
const mapDispatch = {
  ...
  // addWeaponKeyword: (obj: WeaponKeyword) => ({ type: 'ADD', dataType: 'weapon_keywords', payload: obj })
}
          ...
          <Grid container spacing={1} direction="column">
            ...
            <Grid item>
              ...
              <Tooltip title={`Edit ${this.state.obj.name}`}>
                <Fab size="small" color="primary" style={{marginLeft: "8px"}}
                  onClick={ () => {
                    this.setState({ redirectTo:`/beyond/weapon_keyword/edit/${this.state.obj._id}` });
                  }}>
                  <Edit/>
                </Fab>
              </Tooltip> 
