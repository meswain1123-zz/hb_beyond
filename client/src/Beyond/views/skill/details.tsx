...
const mapDispatch = {
  ...
  // addSkill: (obj: Skill) => ({ type: 'ADD', dataType: 'skills', payload: obj })
}
          ...
          <Grid container spacing={1} direction="column">
                  ...
                  onClick={ () => {
                    this.api.deleteObject(this.state.obj).then((res: any) => {
                      if (this.props.objects) {
                        this.props.setSkills(this.props.objects.filter(o => o._id !== this.state.obj._id));
                        this.setState({ redirectTo:`/beyond/skill` });
                      }
                    });
                  }}>
            ...
            <Grid item>
              ...
              <Tooltip title={`Edit ${this.state.obj.name}`}>
                <Fab size="small" color="primary" style={{marginLeft: "8px"}}
                  onClick={ () => {
                    this.setState({ redirectTo:`/beyond/skill/edit/${this.state.obj._id}` });
                  }}>
                  <Edit/>
                </Fab>
              </Tooltip> 
            ...
            <Grid item 
              ...
              <Grid container spacing={1} direction="row">
                ...
                <Grid item xs={9}>
                  {this.state.obj.use_ability_score}
                </Grid>
              </Grid>
            </Grid>
          </Grid>
