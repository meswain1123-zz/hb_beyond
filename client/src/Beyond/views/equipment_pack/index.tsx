...
class EquipmentPackIndex extends Component<Props, State> {
  ...
  render() {
    if (this.state.loading) {
      ...
      const page_size = 7;
      const filtered: any[] = this.state.equipment_packs ? this.state.equipment_packs.filter(o => 
        ...
        <Grid container spacing={1} direction="column">
          <Grid item container spacing={1} direction="row">
            <Grid item xs={3}>
              ...
              <Tooltip title={`Create New Equipment Pack`}>
                <Fab size="small" color="primary" style={{marginLeft: "8px"}}
                  onClick={ () => {
                    this.setState({ redirectTo:`/beyond/equipment_pack/create` });
                  }}>
                  <Add/>
                </Fab>
              </Tooltip> 
                    ...
                    <Grid item xs={2}>
                      <Tooltip title={`View details for ${o.name}`}>
                        <Button 
                          ...
                          onClick={ () => {
                            this.setState({ redirectTo:`/beyond/equipment_pack/details/${o._id}` });
                          }}>
                            {o.name}
                        </Button>
                      </Tooltip>
                    ...
                    <Grid item xs={1}>
                      <Tooltip title={`Edit ${o.name}`}>
                        <Fab size="small" color="primary"
                          ...
                          onClick={ () => {
                            this.setState({ redirectTo:`/beyond/equipment_pack/edit/${o._id}` });
                          }}>
                          <Edit/>
                        </Fab>
                      </Tooltip> 
                        ...
                        <Fab size="small" color="primary"
                          ...
                          onClick={ () => {
                            this.setState({ processing: true }, () => {
                              const new_obj = new EquipmentPack();
                              new_obj.copy(o);
...
export default connector(EquipmentPackIndex);
