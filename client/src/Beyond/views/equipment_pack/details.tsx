...
class EquipmentPackDetails extends Component<Props, State> {
  ...
  load_object(id: string) {
    this.setState({ loading: true }, () => {
      this.api.getFullObject("equipment_pack", id).then((res: ModelBase | null) => {
        if (res) {
          this.setState({ obj: (res as EquipmentPack).clone(), loading: false });
        }
      });
    });
  }
