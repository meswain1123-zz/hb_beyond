  ...
  render() {
    ...
    return (
      <Grid item container spacing={1} direction="column">
        <Grid item>
          <TemplateBox
            ...
            useTemplate={(template: TemplateBase) => {
              const ability_template: AbilityTemplate = template as AbilityTemplate;
        ...
        <Grid item container spacing={1} direction="row">
          <Grid item xs={6} container spacing={1} direction="row">
...
export default connector(AbilityInput);
